...
blockquote {
  ...
  background-image: url("/devtools/xamarin/assets/important-icon.svg");
  color: #fff;
  ...
  blockquote.caution {
    ...
    background-image: url("/devtools/xamarin/assets/caution-icon.svg"); }
  blockquote.tip {
    background-color: #e4f1df;
    background-image: url("/devtools/xamarin/assets/tip-icon.svg"); }
