...
>Prior R2 2017 you would still need to manually register the Calendar renderer following these steps [Register Calendar Renderer]({% slug calendar-getting-started-register-renderer %})
