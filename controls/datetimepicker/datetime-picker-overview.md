...
* **String format**: Date and Time Picker for Xamarin allows you to set a standard and custom date and time format string through the SpinnerFormatString property. Depending on what string format is set, the picker dialog visualizes the needed values to be picked. This feature allows you easily to create a date picker, time picker or combination of both. For more information check the [DateTime Format String]({%slug datetime-picker-format-string%}) topic in our documentation.
