---
title: Token-Based NuGet Authentication
page_title: Token-Based NuGet Authentication for Xamarin Packages 
description: "Learn how to use NuGet Keys to authenticate with the Telerik NuGet server and restore Telerik UI for Xamarin packages in your CI or desktop environment."
slug: using-nuget-keys
position: 9
---

# Token-Based NuGet Authentication for CI Workflows
