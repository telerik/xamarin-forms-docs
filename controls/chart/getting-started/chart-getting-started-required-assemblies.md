...
This article contains a list with the assemblies required by the **RadChart** control.
...
>Prior R2 2017 you would still need to manually register the Chart control renderer following these steps [Register Chart Renderer]({% slug chart-getting-started-register-renderer %})
