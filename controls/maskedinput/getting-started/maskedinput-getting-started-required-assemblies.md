...
position: 1
slug: maskedinput-getting-started-required-assemblies
---
# Required Telerik Assemblies

This article contains a list of the assemblies required by the **RadMaskedInput** control.
...
- [MaskedInput Getting Started]({% slug maskedinput-getting-started %})